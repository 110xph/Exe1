 ...
 *          作为参数来执行函数can_add_callback(msg_rcv_func),msg_rcv_func()函数就会在接收到
...
#define CAN_MODE_X CAN_Mode_LoopBack  //模式
...
void can_rcv_msg(CanRxMsg *can_rx_msg);				//发送消息
