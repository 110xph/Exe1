...
typedef struct
{
  ...
  uint8_t Data[500]; /*!< Contains the data to be transmitted. It ranges from 0 
                        to 0xFF. */
} CanTxMsg;
...
typedef struct
{
  ...
  uint8_t Data[500]; /*!< Contains the data to be received. It ranges from 0 to 
                        0xFF. */
...
#define IS_CAN_DLC(DLC)       ((DLC) <= ((uint8_t)0xff))
/**
  * @}
  */
